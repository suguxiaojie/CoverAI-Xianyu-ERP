  ...
  test('订单筛选栏渲染状态、账号和关键词输入', /* 当前回调处理订单筛选工具栏的静态结构。 */ () => {
    ...
    const markup = render(<OrderFilterBar
      ...
      onAccountFilterChange={noopFilterChange}
			...
			onCreatedRangeChange={/* dateRangeChangeMock 忽略静态渲染中的时间范围更新。 */ () => undefined}
			amountRange={{ minAmount: '', maxAmount: '', label: '金额范围' }}
			onAmountRangeChange={/* amountRangeChangeMock 忽略静态渲染中的金额范围更新。 */ () => undefined}
