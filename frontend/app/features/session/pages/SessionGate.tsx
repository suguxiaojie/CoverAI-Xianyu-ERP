...
import { CoverAIBrandIcon } from '../../../../shared/ui/CoverAILogo';
...
export const SessionGate: React.FC = () => {
  ...
  const description = needsInit ? '设置完成后会自动进入系统，管理员账号为 admin。' : 'CoverAI闲鱼助手 · 自动发货与管家系统';
      ...
      <section className="w-full max-w-lg rounded-xl border border-white bg-white/80 p-8 shadow-panel backdrop-blur-3xl md:p-12">
        <header className="mb-8 text-center">
          <div className="mx-auto mb-6 flex justify-center">
            <CoverAIBrandIcon sizeClass="h-24 w-24" />
          </div>
