...
const AuthenticatedShell: React.FC<AuthenticatedShellProps> = ({
  ...
  return (
    ...
    <main className="min-h-screen min-w-0 overflow-x-hidden bg-white pt-16">
      <div className={`${activeTab === 'chat' ? 'mx-auto h-[calc(100vh-4rem)] max-w-[1680px] p-3' : 'mx-auto max-w-[1600px] px-5 py-5 lg:px-7 lg:py-6'}`}>
        <AppContent
          activeTab={activeTab}
          isAdmin={isAdmin}
          deliveryRuleTarget={deliveryRuleTarget}
