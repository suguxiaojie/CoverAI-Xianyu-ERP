...
// UpdateSKUCost 返回测试预设的本地 SKU 成本更新错误。
func (repository *catalogMutationRepositoryStub) UpdateSKUCost(context.Context, string, string, string, *int64) error {
	return repository.multiQuantityErr
}

// UpdateSKUCosts 返回测试预设的批量本地成本更新错误。
func (repository *catalogMutationRepositoryStub) UpdateSKUCosts(context.Context, string, string, []SKUCostInput) error {
	return repository.multiQuantityErr
}
