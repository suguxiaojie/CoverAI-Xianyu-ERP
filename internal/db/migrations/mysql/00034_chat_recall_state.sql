...
ALTER TABLE chat_messages ADD COLUMN platform_message_id VARCHAR(255) NULL;
ALTER TABLE chat_messages ADD COLUMN recalled_at BIGINT NOT NULL DEFAULT 0;
ALTER TABLE chat_messages ADD COLUMN recall_operator_type INTEGER NOT NULL DEFAULT -1;
ALTER TABLE chat_messages ADD COLUMN recall_operator_id VARCHAR(255) NOT NULL DEFAULT '';
...
-- +goose Down
-- +goose StatementBegin
DROP INDEX uq_chat_messages_account_platform_id ON chat_messages;
