-- +goose Up
ALTER TABLE automation_runs ADD COLUMN lease_expires_at BIGINT NOT NULL DEFAULT 0;
ALTER TABLE automation_runs ADD COLUMN attempt_count INTEGER NOT NULL DEFAULT 1;
ALTER TABLE automation_runs ADD COLUMN next_retry_at BIGINT NOT NULL DEFAULT 0;
