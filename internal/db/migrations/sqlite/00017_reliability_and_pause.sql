-- +goose Up
ALTER TABLE default_reply_records ADD COLUMN lease_expires_at INTEGER NOT NULL DEFAULT 0;
ALTER TABLE cookies ADD COLUMN paused_until INTEGER NOT NULL DEFAULT 0;
ALTER TABLE item_publish_batches ADD COLUMN worker_token TEXT NOT NULL DEFAULT '';
ALTER TABLE item_publish_batches ADD COLUMN lease_expires_at INTEGER NOT NULL DEFAULT 0;
