...
func newApplicationAccountTaskSettingsResponse(settings automationapp.AccountTaskSettings) accountTaskSettingsResponse {
	return accountTaskSettingsResponse{
		...
		AutoRequestFlowerEnabled: settings.AutoRequestFlowerEnabled, RequestFlowerAfterHours: settings.RequestFlowerAfterHours,
		RequestFlowerAfterSeconds: settings.RequestFlowerAfterSeconds,
		AutoReceiveFlowerEnabled:  settings.AutoReceiveFlowerEnabled, ReceiveFlowerShowBrowser: settings.ReceiveFlowerShowBrowser,
		ReceiveFlowerTimeoutSeconds: settings.ReceiveFlowerTimeoutSeconds,
		AutoReceiptReminderEnabled:  settings.AutoReceiptReminderEnabled, ReceiptReminderAfterDays: settings.ReceiptReminderAfterDays,
		ReceiptReminderTime: settings.ReceiptReminderTime, ReceiptReminderMessage: settings.ReceiptReminderMessage,
		ReceiptReminderEnabledAt: settings.ReceiptReminderEnabledAt,
