...
type AccountLoginPort interface {
	...
	PersistQRLoginSuccess(context.Context, int64, string, map[string]any, string, string) (AccountLoginResult, error)
...
type OrdersPort interface {
	...
	ConversationContext(context.Context, orderapp.ConversationContextQuery) (orderapp.ConversationContextResult, error)
	...
	ShipWithEvidence(context.Context, orderapp.ShipmentEvidenceRequest) (orderapp.ShipmentEvidenceResult, error)
	ShipmentProof(context.Context, int64, string) (orderapp.ShipmentProofResult, error)
	RequestRedFlower(context.Context, orderapp.RedFlowerRequest) (orderapp.RedFlowerRequestResult, error)
	RedFlowerStatus(context.Context, int64, string) (orderapp.RedFlowerRequestStatusResult, error)
	PriceAdjustmentForm(context.Context, orderapp.PriceAdjustmentFormRequest) (orderapp.PriceAdjustmentFormResult, error)
	AdjustPrice(context.Context, orderapp.PriceAdjustmentRequest) (orderapp.PriceAdjustmentResult, error)
	RefundDetail(context.Context, orderapp.RefundDetailRequest) (orderapp.RefundDetailResult, error)
	RefundAction(context.Context, orderapp.RefundActionRequest) (orderapp.RefundActionResult, error)
	StartMerchantRefundVerification(context.Context, orderapp.MerchantRefundVerificationStartRequest) (orderapp.MerchantRefundVerificationStartResult, error)
	CompleteMerchantRefundVerification(context.Context, orderapp.MerchantRefundVerificationCompleteRequest) (orderapp.RefundActionResult, error)
	MerchantRefundRefuseForm(context.Context, orderapp.MerchantRefundRefuseFormRequest) (orderapp.MerchantRefundRefuseFormResult, error)
	RefuseMerchantRefund(context.Context, orderapp.MerchantRefundRefuseRequest) (orderapp.RefundActionResult, error)
	CloseOrderEligibility(context.Context, orderapp.CloseOrderEligibilityRequest) (orderapp.CloseOrderEligibilityResult, error)
	CloseOrderReasons(context.Context, orderapp.CloseOrderReasonsRequest) (orderapp.CloseOrderReasonsResult, error)
	CloseOrder(context.Context, orderapp.CloseOrderRequest) (orderapp.CloseOrderResult, error)
}
...
type OrderRefreshJobsPort interface {
	...
	CreateAndStartInMode(context.Context, int64, string, string, string) (orderapp.RefreshJobStartResult, error)
...
type ItemCatalogMutationPort interface {
	...
	UpdateSKUCost(context.Context, string, string, string, *int64) error
	UpdateSKUCosts(context.Context, string, string, []itemapp.SKUCostInput) error
}
...
type ChatPort interface {
	...
	SendLocationCard(context.Context, chatapp.LocationInput) (*chatapp.Message, error)
	Recall(context.Context, chatapp.RecallInput) (*chatapp.Message, error)
	...
	SearchSessions(context.Context, int64, string, string, int) ([]chatapp.Session, error)
	SetSessionPinned(context.Context, int64, string, string, bool) error
	...
	GetUserCredit(context.Context, int64, string, string) (chatapp.CreditProfile, error)
}
...
type AnalyticsPort interface {
	...
	// ManualCostCandidates 返回需要人工确认的历史订单金额分组。
	ManualCostCandidates(context.Context, analyticsapp.Query) ([]analyticsapp.ManualCostCandidate, error)
	// ConfirmManualCostCandidate 为人工确认分组生成不可变成本快照。
	ConfirmManualCostCandidate(context.Context, analyticsapp.ManualCostConfirmation) (analyticsapp.ManualCostConfirmationResult, error)
}
...
type CardsPort interface {
	...
	GetImage(context.Context, int64, int64) (cardsapp.ImageAsset, error)
	ExistsOwned(context.Context, int64, int64) (bool, error)
	Create(context.Context, int64, cardsapp.Draft) (int64, error)
	CreateWithImage(context.Context, int64, cardsapp.Draft, *cardsapp.ImageInput) (int64, error)
	Update(context.Context, int64, int64, cardsapp.Draft) error
	UpdateWithImage(context.Context, int64, int64, cardsapp.Draft, *cardsapp.ImageInput) error
	Delete(context.Context, int64, int64) error
...
type KeywordsPort interface {
	...
	ListGroups(context.Context, int64, string) ([]keywordsapp.Group, error)
	SaveGroup(context.Context, int64, string, keywordsapp.GroupDraft) (string, error)
	DeleteGroup(context.Context, int64, string, string) error
	ListGlobalGroups(context.Context, int64) ([]keywordsapp.Group, error)
	SaveGlobalGroup(context.Context, int64, keywordsapp.GroupDraft) (string, error)
	DeleteGlobalGroup(context.Context, int64, string) error
	SetGlobalGroupEnabled(context.Context, int64, string, bool) error
	SetAllGlobalGroupsEnabled(context.Context, int64, bool) error
	SetGlobalGroupAccountEnabled(context.Context, int64, string, string, bool) error
...
// KnowledgePort 定义知识库 HTTP 路由需要的最小应用用例能力。
type KnowledgePort interface {
	ListBases(context.Context, int64) ([]knowledgeapp.Base, error)
	GetBase(context.Context, int64, int64) (knowledgeapp.Base, error)
	CreateBase(context.Context, int64, knowledgeapp.BaseDraft) (int64, error)
	UpdateBase(context.Context, int64, int64, knowledgeapp.BaseDraft) error
	SetBaseStatus(context.Context, int64, int64, knowledgeapp.BaseStatus) error
	DeleteBase(context.Context, int64, int64) error
	ListEntries(context.Context, int64, int64) ([]knowledgeapp.Entry, error)
	CreateEntry(context.Context, int64, int64, knowledgeapp.EntryDraft) (int64, error)
	UpdateEntry(context.Context, int64, int64, int64, knowledgeapp.EntryDraft) error
	ReviewEntry(context.Context, int64, int64, int64, knowledgeapp.ContentType, bool) error
	SetEntryEnabled(context.Context, int64, int64, int64, knowledgeapp.ContentType, bool) error
	DeleteEntry(context.Context, int64, int64, int64, knowledgeapp.ContentType) error
	ListFAQAliases(context.Context, int64, int64, int64) ([]knowledgeapp.FAQAlias, error)
	CreateFAQAlias(context.Context, int64, int64, int64, knowledgeapp.FAQAliasDraft) (int64, error)
	DeleteFAQAlias(context.Context, int64, int64, int64, int64) error
	SuggestFAQAliases(context.Context, int64, int64, int64) ([]string, error)
	Retrieve(context.Context, knowledgeapp.RetrieveRequest) (knowledgeapp.RetrieveResult, error)
}
...
type ApplicationPorts struct {
	...
	// knowledge 是人工 FAQ／文档、审核与离线检索用例。
...
func NewApplicationPorts(input ApplicationPortsInput) *ApplicationPorts {
	return &ApplicationPorts{
		...
		keywords: input.Keywords, knowledge: input.Knowledge, settings: input.Settings, admin: input.Admin,
	}
}
...
func (ports *ApplicationPorts) validate() error {
	...
	required := []struct {
		...
		{"default_replies", ports.defaultReplies}, {"keywords", ports.keywords}, {"knowledge", ports.knowledge}, {"settings", ports.settings}, {"admin", ports.admin},
	}
