...
// UpdateProgress 满足订单刷新任务仓储接口；历史生命周期测试不验证运行中进度。
func (repository orderRefreshLifecycleRepository) UpdateProgress(context.Context, string, string, string) (bool, error) {
	return true, nil
}
