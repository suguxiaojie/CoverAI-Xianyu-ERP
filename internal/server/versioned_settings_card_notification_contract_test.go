...
func TestVersionedSettingsCardNotificationRoutesPreserveLegacyContracts(t *testing.T) {
	...
	cases := []settingsCardNotificationRouteCase{
		...
		{name: "card-image-invalid", method: http.MethodGet, versionedPath: "/api/v1/cards/invalid/image", legacyPath: "/cards/invalid/image", wantStatus: http.StatusBadRequest},
